...
const initialProducts: Product[] = [
  {
    id: '1',
    name: 'Oeufs de Cailles',
    description: 'Oeufs de caille frais de notre ferme, riches en protéines et en nutriments. Parfaits pour une alimentation saine.',
    price: 2000,
    unit: 'douzaine',
    category: 'eggs',
  ...
  {
    id: '2',
    name: 'Viande de Caille',
    description: 'Viande de caille fraîche et tendre, élevée naturellement. Idéale pour vos grillades et plats raffinés.',
    price: 15000,
    unit: 'kg',
    category: 'meat',
